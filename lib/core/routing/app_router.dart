...
import '../../features/ai_summary/presentation/ai_summary_page.dart';
...
import '../../features/pdf_to_excel/presentation/pdf_to_excel_page.dart';
import '../../features/pdf_to_word/presentation/pdf_to_word_page.dart';
...
import '../../features/watermark/presentation/watermark_page.dart';
...
abstract final class AppRouter {
  static Route<void> onGenerateRoute(RouteSettings settings) {
    final Widget page = switch (settings.name) {
      ...
      AppRoutes.watermark => const WatermarkPage(),
      AppRoutes.translate => const TranslatePage(),
      AppRoutes.aiSummary => const AiSummaryPage(),
      AppRoutes.pdfToExcel => const PdfToExcelPage(),
      AppRoutes.pdfToWord => const PdfToWordPage(),
      _ => const HomePage(),
    };
